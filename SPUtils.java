...
public class SPUtils {
     ...
     * 保存在手机里面的文件名
     */
    public static final String FILE_NAME = "jetsen_mentor";
    ...
    public static boolean saveArray(List<Integer> list, Context mContext) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            mEdit1.putInt("Status_" + i, list.get(i));
        }
        return mEdit1.commit();
    }

    public static void loadArray(List<Integer> list, Context mContext) {

        SharedPreferences mSharedPreference1 = mContext.getSharedPreferences("ingoreList", mContext.MODE_PRIVATE);
        list.clear();
        int size = mSharedPreference1.getInt("Status_size", 0);
        for (int i = 0; i < size; i++) {
            int anInt = mSharedPreference1.getInt("Status_" + i, 0);
            list.add(anInt);
